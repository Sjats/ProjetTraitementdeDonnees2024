...
# mon_test.plot_histogramme(False, None)
#mon_test.AfficherCarte(False)

with open("bdd_indice_prod.pkl", "rb") as file:
    ind_prod = pickle.load(file)
with open("bdd_indice_cat.pkl", "rb") as file:
    ind_cat = pickle.load(file)
#print(ind_cat)
print(ind_prod['France'].keys())
print(ind_cat['France'].keys())
